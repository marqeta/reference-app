...
amount = 40.0
print("Simulating authorization incremental transaction for amount:", amount)
request_url = f"{base_url}/simulations/cardtransactions/authorization.incremental"
payload = {
    "amount": amount,
...
payload = {
    "amount": amount,
    "preceding_related_transaction_token": token2,
    "card_token": "reference_app_card_1",
    "mid": "1235",
    "card_acceptor": {
        "zip": "94115",
